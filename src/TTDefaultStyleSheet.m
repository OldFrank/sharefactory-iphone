...
- (TTStyle*)tabGrid {
  ...
  UIColor* highlight = RGBACOLOR(255, 255, 255, 0.7);
	UIColor* shadow = [UIColor blackColor];//[color multiplyHue:1 saturation:1.1 value:0.86];
  return
...
- (TTStyle*)tabGridTab:(UIControlState)state corner:(short)corner {
  ...
  if (state == UIControlStateSelected) {
    ...
    return
      ...
      [TTBoxStyle styleWithPadding:UIEdgeInsetsMake(11, 10, 9, 10) next:
      [TTPartStyle styleWithName:@"image" style:[self tabGridTabImage:state] next:
      [TTTextStyle styleWithFont:[UIFont boldSystemFontOfSize:11]  color:[UIColor purpleColor]
  ...
  if (state == UIControlStateSelected) {
    ...
    return
      ...
      [TTTextStyle styleWithFont:[UIFont boldSystemFontOfSize:14]  color:TTSTYLEVAR(textColor)
                   minimumFontSize:8 shadowColor:[UIColor blackColor]
                   shadowOffset:CGSizeMake(0, -1) next:nil]]]]]]]; // shadowColor:[UIColor colorWithWhite:1 alpha:0.8]
  } else {
    return
      ...
      [TTTextStyle styleWithFont:[UIFont boldSystemFontOfSize:14]  color:[UIColor whiteColor]
                   ...
                   shadowOffset:CGSizeMake(0, -1) next:nil]]]; //shadowColor:[UIColor colorWithWhite:0 alpha:0.6]
  }
}
...
- (TTStyle*)tabRound:(UIControlState)state {
  if (state == UIControlStateSelected) {
    return
      ...
      [TTShadowStyle styleWithColor:RGBACOLOR(0,0,0,0.8) blur:0 offset:CGSizeMake(0, 1) next:
	  ...
	  /*[TTTextStyle styleWithFont:[UIFont boldSystemFontOfSize:13]  color:[UIColor whiteColor]
	   minimumFontSize:8 shadowColor:[UIColor colorWithWhite:0 alpha:0.5]
	   shadowOffset:CGSizeMake(0, -1) next:nil]]]]]]]];*/ //      [TTShadowStyle styleWithColor:RGBACOLOR(255,255,255,0.8) blur:0 offset:CGSizeMake(0, 1) next:
...
//                 shadowOffset:CGSizeZero next:nil]];
	[TTTextStyle styleWithFont:[UIFont boldSystemFontOfSize:11] color:RGBCOLOR(0, 0, 0)
			   minimumFontSize:11 shadowColor:nil
				  shadowOffset:CGSizeZero next:nil]];//Sean... ugly code...
}
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (UIColor*)textColor {
	return [UIColor whiteColor];//[UIColor blackColor];
}
...
- (UIColor*)linkTextColor {
	return [UIColor whiteColor];//RGBCOLOR(87, 107, 149);
}
...
- (UIColor*)tabBarTintColor {
  return RGBCOLOR(50, 50, 50);//RGBCOLOR(119, 140, 168);
}


///////////////////////////////////////////////////////////////////////////////////////////////////
- (UIColor*)tabTintColor {
	return [UIColor blackColor];//RGBCOLOR(228, 230, 235);
}
