...
- (id)initWithFrame:(CGRect)frame  {
  if (self = [super initWithFrame:frame]) {
	...
	////  
//	  _scrollView.contentOffset = CGPointMake(630, 0.0); //290 // La Liga needs a better way
    ////
...
- (void)setTabItems:(NSArray*)tabItems {
	...
	CGSize size = [super layoutTabs];
	_scrollView.contentOffset = CGPointMake(size.width - 320 + kTabMargin, 0.0);
}

- (void)setSelectedTabIndex:(NSInteger)index {
	[super setSelectedTabIndex:index];
}
